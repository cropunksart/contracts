...
contract CROPUNK is ERC721Enumerable, Auth {
    ...
    uint256 private MAX_SUPPLY = 1111;

    address private fundAddress;

    constructor()
        ERC721("CroPunks - Punks on Cronos", "CROPUNK")
        Auth(msg.sender)
    {
        mintPrice = 0 ether;
    ...
    function mintNFTs(uint256 numberOfNfts) external payable {
        ...
        require(msg.value == totalCost, "Not enough CRO");
